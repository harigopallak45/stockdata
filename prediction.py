...
def log_plot_success(filepath, plot_path, model_name):
    """
    Logs the success or failure of a plot and checks if the image file was updated.
    """
    try:
...
def analyze_data(filepath):
    try:
        ...
        log_plot_success(filepath, month_wise_diff_plot_path, "Month-Wise Difference")
        ...
        log_plot_success(filepath, historical_vs_predictions_plot_path, "Historical vs Predictions")
...
def prophet_prediction(filepath):
    ...
    try:
        ...
        log_plot_success(filepath, prophet_plot_path, "Prophet")
...
def lstm_prediction(filepath):
    ...
    try:
        ...
        log_plot_success(filepath, lstm_plot_path, "LSTM")
...
def xgboost_prediction(filepath):
    ...
    try:
        ...
        logging.info("Making predictions with XGBoost model.")
        ...
        log_plot_success(filepath, xgboost_plot_path, "XGBoost")
        logging.info("XGBoost predictions generated successfully.")

        return xgboost_plot_path  # Ensure this is returned
...
def prophet_prediction(filepath):
    try:
        ...
        logging.info(f'Forecast generated with {len(forecast)} rows.')
